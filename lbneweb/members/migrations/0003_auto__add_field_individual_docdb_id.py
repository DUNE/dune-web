...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individual.docdb_id'
        db.add_column('members_individual', 'docdb_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individual.docdb_id'
        db.delete_column('members_individual', 'docdb_id')
