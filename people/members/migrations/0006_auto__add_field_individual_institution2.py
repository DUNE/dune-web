...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individual.institution2'
        db.add_column('members_individual', 'institution2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='institution2', null=True, to=orm['members.Institution']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individual.institution2'
        db.delete_column('members_individual', 'institution2_id')
